				...
				//all transporter found
					for (int a = 0; a < xLocation; a++) {
						for (int b = 0; b < yLocation; b++) {
							if (grid[a][b] != null ) {
							if(grid[a][b].getClass().equals(HorizontalTransporter.class) || grid[a][b].getClass().equals(VerticalTransporter.class)|| grid[a][b].getClass().equals(NearestTransporter.class) ) {
//								System.out.print("a");
